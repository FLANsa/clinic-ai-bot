...
export default function TestChatPage() {
  ...
  const handleAddNorthBranchData = async () => {
    ...
    try {
      ...
      if (errorMessage.includes('الجداول غير موجودة') || errorMessage.includes('does not exist')) {
        alert(`❌ ${errorMessage}\n\n💡 الحل: اضغط على زر "تهيئة قاعدة البيانات" أولاً، ثم حاول مرة أخرى.`)
      } else {
