  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">العروض والخصومات المتاحة</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {offers.map((offer) => (
          <div
            key={offer.id}
            className={`bg-gradient-to-br from-white to-blue-50 rounded-xl shadow-sm border border-blue-100 p-5 hover:shadow-md transition-shadow ${
          ...
          >
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg p-3 text-center">
              ...
              <span className="block text-sm opacity-90">خصم</span>
            </div>
          </div>
        ))}
      </div>
